...
class NavTest():
    def __init__(self):
        ...
        locations['hall_foyer'] = Pose(Point(6.643, 4.720, 0.000), Quaternion(0.000, 0.000, 0.223, 0.975))
        ...
        locations['living_room_1'] = Pose(Point(5.720, 2.229, 0.000), Quaternion(0.000, 0.000, 0.786, 0.618))
